...
BLOG_AUTHOR = "Jesper Dramsch"  # (translatable)
BLOG_TITLE = "Real-world Perspectives to Avoid the Worst Mistakes using ML in Science"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://realworld-ml.xyz/"
...
POSTS = (
    ("talks/*.md", "talks", "post.tmpl"),
    ("talks/*.rst", "talks", "post.tmpl"),
    ("talks/*.txt", "talks", "post.tmpl"),
    ("talks/*.html", "talks", "post.tmpl"),
)
PAGES = (
    ("pages/*.md", "", "page.tmpl"),
    ("pages/*.rst", "", "page.tmpl"),
...
LUXON_DATE_FORMAT = {
    DEFAULT_LANG: {"preset": False, "format": "%B %d, %Y"},
    # DEFAULT_LANG: { weekday: 'long', month: 'long', day: 'numeric', year: 'numeric'},
}
...
# LOGO_URL = '/images/Ampersands-ML-workshop.png'
...
REDIRECTIONS = [
    ("tickets/index.html", "https://pydata.org/global2022/tickets/"),
    (
        "time/index.html",
        "https://www.timeanddate.de/zeitzonen/events?msg=Real-world+Perspectives+to+Avoid+the+Worst+Mistakes+using+Machine+Learning+in+Science&iso=20221202T13&p1=%3A&ah=2",
    ),
...
# (translatable)
CONTENT_FOOTER = 'Contents &copy; {date}         <a href="mailto:{email}">{author}</a> - More projects at         <a href="https://dramsch.net">dramsch.net</a>         {license}'
