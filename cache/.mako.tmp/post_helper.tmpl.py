...
_magic_number = 10
_modified_time = 1669217898.8943148
_enable_loop = True
_template_filename = 'themes/maupassant/templates/post_helper.tmpl'
    ...
    try:
        ...
        if post.prev_post or post.next_post:
            ...
            if post.prev_post:
                ...
                __M_writer('">')
                __M_writer(str(messages("Previous post").replace("post", "talk")))
                __M_writer('</a>\n            </li>\n')
            if post.next_post:
                ...
                __M_writer('">')
                __M_writer(str(messages("Next post").replace("post", "talk")))
                __M_writer('</a>\n            </li>\n')
            __M_writer('        </ul>\n')
        return ''
    finally:
